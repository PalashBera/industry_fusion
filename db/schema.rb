...
ActiveRecord::Schema.define(version: 2020_03_30_151408) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "invited_by_id_type"
    t.bigint "invited_by_id_id"
    ...
    t.index ["invited_by_id_type", "invited_by_id_id"], name: "index_users_on_invited_by_id_type_and_invited_by_id_id"
