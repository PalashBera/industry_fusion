class Admin::QcApprovalLevelsController < Admin::HomeController
  def index
    @approval_levels = ApprovalLevel.qc.included_resources
  end
  ...
  def destroy
    ...
    redirect_to admin_qc_approval_levels_path, flash: { error: t("flash_messages.deleted", name: "QC approval level") }
  end
